...
def angle_histogram(ri, mi, d=765000, nalpha=100, logalphamin=-5): #8200 to 788280 #logalphamin=-2... 765 now because this is what Karwin used.
    ...
    """
    alpha = np.logspace(logalphamin, np.log10(0.261799), nalpha) # np.log10(np.pi) to 
