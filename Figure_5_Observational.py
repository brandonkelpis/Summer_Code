...
plt.plot(radii[:i],y2[:i], label = 'stellar disk', color = 'blue')

plt.plot(radii[:i],y1[:i], label = 'bulge', color = 'purple')

plt.plot(radii[:i],baryon[:i], label = 'all baryons', color = 'green')

plt.plot(radii[:i],y6[:i], label = 'total', color = 'orange')
