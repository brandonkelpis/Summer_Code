...
class MilkyWay():
    ...
    def create_dm_orbits(self, ntot=10000, nsteps=10000, tmax=1e10, rmax=650e3, components="hbs", seed=42, addinfo=False, subsamp=1, adaptive=False, verbose=False, mpicomm=None): #R_max originally at 500e3...made bigger because M31 is larger. 
